...
penguins-eggs is on [Openmamba repos](https://openmamba.org/it/rpms/base/), you can install it just with: `sudo dnf install penguins-eggs`.

Here You can find the last published package from the penguins-eggs developer.
