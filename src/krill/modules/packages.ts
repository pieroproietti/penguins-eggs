    ...
    if (fs.existsSync(config_file)) {
        ...
        if (operations !== undefined) {
            ...
            if (operations.length > 1) {
                packagesRemove = operations[0].remove
