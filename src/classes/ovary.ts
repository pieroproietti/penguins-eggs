...
timeout 200\n`
  ...
  async makeLiveHome(verbose = false) {
    ...
    shx.cp(path.resolve(__dirname, `../../assistant/assistant.sh`), `/usr/lib/node_modules/penguins-eggs/assistant/assistant.sh`)
    shx.cp(path.resolve(__dirname, `../../assistant/assistant.html`), `/usr/lib/node_modules/penguins-eggs/assistant/assistant.html`)
