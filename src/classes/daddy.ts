...
export default class Daddy {
  ...
  async helpMe(loadDefault = false, verbose = false) {
    ...
    if (await this.settings.load()) {
      ...
      console.log()
      console.log(chalk.cyan(`You can create a new iso with: `) + chalk.white(`sudo eggs produce`))
      console.log(chalk.cyan(`Or a complete personal clone: `) + chalk.white(`sudo eggs produce --clone`))
      console.log()
      console.log(chalk.cyan(`If you are scarce of free space you can mount remote`))
      console.log(chalk.cyan(`or local space. Follow the samples:`))
      console.log(chalk.cyan(`First: create the eggs mountpoint`))
      console.log(chalk.white(`sudo mkdir /home/eggs/mnt -p`))
      console.log(chalk.cyan(`then, to use remote space:`))
      console.log(chalk.white(`sudo sshfs -o allow_other root@192.168.1.2:/zfs/iso /home/eggs/mnt`))
      console.log(chalk.cyan('or, for a local partition'))
