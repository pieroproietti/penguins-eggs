    ...
    if (versionLike === 'buster') {
      ...
      settings = {
        ...
        sequence: [
          ...
          {exec: ['partition', 'mount', 'unpackfs', 'sources-media', 'machineid', 'fstab', 'locale', 'keyboard', 'localecfg', 'users', 'networkcfg', 'hwclock', 'grubcfg', 'bootloader', 'packages', 'luksbootkeyfile', 'plymouthcfg', 'initramfscfg', 'initramfs', 'source-media-unmount', 'source-final', 'removeuser', 'umount']},
          {show: ['finished']},
        ],
