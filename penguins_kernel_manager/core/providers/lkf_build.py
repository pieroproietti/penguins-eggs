...
Build output lands in LKF_OUTPUT_DIR (default: ~/.cache/penguins-kernel-manager/lkf-output/).
"""
...
_DEFAULT_OUTPUT_DIR = Path.home() / ".cache" / "penguins-kernel-manager" / "lkf-output"
