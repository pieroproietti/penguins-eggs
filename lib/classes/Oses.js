...
class Oses {
    info(distro) {
        let info;
        (function (info) {
            info[info["HOME_URL"] = 0] = "HOME_URL";
            info[info["SUPPORT_URL"] = 1] = "SUPPORT_URL";
            info[info["BUG_REPORT_URL"] = 2] = "BUG_REPORT_URL";
        })(info || (info = {}));
        ;
        let os = new Array();
         ...
         * lsb_release -c -s
         */
        o.versionId = (shelljs_1.default.exec('lsb_release -c -s', { silent: true }).stdout).toString().trim();
        ...
        o.menuTitle = `MENU TITLE ${o.distroName} a ${o.distroId}/${o.versionId} derivated. ${utils_1.default.date4label()}`;
        return (o);
    }
}
