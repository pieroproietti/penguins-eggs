...
class Calamares {
    ...
    async create() {
        ...
        utils_1.default.exec(`cp -r ../templates/commons/etc/* /etc/`);
        utils_1.default.exec(`cp -r ../templates/debian/etc/* /etc/`);
        // /usr/lib/calamares
        utils_1.default.exec(`cp -r ../templates/debian/usr/lib/calamares/* /usr/lib/calamares/`);
        // /usr/sbin 
