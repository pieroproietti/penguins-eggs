...
class MainWindow(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.setWindowTitle("lkm — Linux Kernel Manager")
    ...
    def _gentoo_compile(self, entry: KernelEntry) -> None:
        ...
        from lkm.gui.widgets.gentoo_compile_dialog import GentooCompileDialog
    ...
    def _open_build_dialog(self) -> None:
        ...
        from lkm.gui.widgets.lkf_build_dialog import LkfBuildDialog
    ...
    def _about(self) -> None:
        QMessageBox.about(
            self,
            "About lkm",
            "<b>lkm — Linux Kernel Manager</b><br>"
            "Version 0.1.0<br><br>"
