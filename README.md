...
penguins-eggs/7.7.28 linux-x64 node-v8.17.0
$ eggs --help [COMMAND]
USAGE
  $ eggs COMMAND
...
...
_See code: [src/commands/init.ts](https://github.com/pieroproietti/penguins-eggs/blob/v7.7.28/src/commands/init.ts)_
