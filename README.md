...
Although penguins-eggs has only recently been released as an AppImage, it is perhaps the simplest method. All you need to do is download the penguins-eggs AppImage and rename it to `/usr/bin/eggs`.
