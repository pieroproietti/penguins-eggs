...
### 🧠 [coa](./DOCS/3-developer-manual/architecture/overview.md) (**brooding in my dialect**) - The Mind
...
For `eggs` commands, see [eggs Command Reference](./DOCS/2-user-manual/commands.md).

### 🦾 [oa](./DOCS/3-developer-manual/architecture/oa.md) (**eggs in my dialect**) - The Workhorse
**Language: C**
...
> The primary CLI command is **`eggs`** (e.g. `eggs remaster`, `eggs produce`, `eggs sysinstall`, `eggs destroy`). The binary is available as both `eggs` and `coa`. See the [Quick Start](./DOCS/2-user-manual/quickstart.md) for the full command usage.
...
Documentation can be found on [DOCS](./DOCS/README.md). See also the [Manifestum](./DOCS/1-philosophy/manifestum.md) for the founding vision and origins.
