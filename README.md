...
running command...
$ eggs (--version|-v)
penguins-eggs/9.0.5 linux-x64 node-v16.14.2
$ eggs --help [COMMAND]
USAGE
  $ eggs COMMAND
...
...
_See code: [src/commands/analyze.ts](https://github.com/pieroproietti/penguins-eggs/blob/v9.0.5/src/commands/analyze.ts)_
...
_See code: [src/commands/syncfrom.ts](https://github.com/pieroproietti/penguins-eggs/blob/v9.0.5/src/commands/syncfrom.ts)_
...
_See code: [src/commands/syncto.ts](https://github.com/pieroproietti/penguins-eggs/blob/v9.0.5/src/commands/syncto.ts)_
