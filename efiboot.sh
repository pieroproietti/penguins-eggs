...
mkdir -p /tmp/efi
# create bootx64.efi
grub-mkimage -o /tmp/efi/bootx64.efi -O x86_64-efi -p /EFI/BOOT part_gpt part_msdos fat ext2 search_disk_uuid normal configfile linux help loadenv test cat echo
