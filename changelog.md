...
* We have again same problem in /etc/locale.gen, we need en_US.UTF-8 UTF-8 not just en_US.UTF-8
* https://github.com/calamares/calamares/blob/calamares/src/modules/keyboard/kbd-model-map
