...
**DISCLAIM:** using this new feathures can be dangerous for your data, ```syncfrom``` replace all users homes and all servers homes with data from the luck-eggs-backup, insert this data in not appropriate system can easily end in a long disaster recovery.
