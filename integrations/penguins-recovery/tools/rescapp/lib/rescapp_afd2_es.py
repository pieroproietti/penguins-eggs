...
# afd2_title
afd2_title = QtWidgets.QLabel(u"¿Asustado?")
...
afd2_message = QtWidgets.QLabel(u"¡¡¡ " + u"Feliz día<br>de los<br>santos inocentes<br>del año "+this_year+ u" !!!")
...
afd2_pay = QtWidgets.QLabel("Pulsa en cualquier sitio para usar Rescatux / Rescapp .")
