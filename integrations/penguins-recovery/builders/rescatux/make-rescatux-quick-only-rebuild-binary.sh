#!/bin/bash
# Rescatux make-rescatux-quick-only-rebuild-binary script
...
CACHE_STAGES_OPTION="--cache-stages \"bootstrap rootfs\""
CHROOT_FILESYSTEM_OPTION="--chroot-filesystem ext4"
