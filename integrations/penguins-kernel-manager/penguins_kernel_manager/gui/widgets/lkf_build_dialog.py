...
class LkfBuildDialog(QDialog):
    ...
    def _populate_profiles(self) -> None:
        from penguins_kernel_manager.core.providers.lkf_build import _find_lkf_root, _find_profiles
        ...
        if not profiles:
            ...
            return
        for p in profiles:
            from penguins_kernel_manager.core.providers.lkf_build import _parse_profile_name, _parse_profile_version
